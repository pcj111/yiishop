	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->logo?>" alt="" width="352px" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                ...
                                <?php $imgs = \backend\models\GoodsGallery::find()->where(['goods_id'=>$good->id])->all()
                                ?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href=""><?=$good->create_time?></a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to(['cart/cuss'])?>" method="get" class="choose">
						<ul>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					<!-- 商品介绍 start -->
					<div class="introduce detail_div none" style="display: block">
						<div class="attr mt15">

                            <?php $row = \backend\models\GoodsIntro::findOne(['goods_id'=>$good->id])
                            ?>
                            <?=$row->content?>
						</div>
