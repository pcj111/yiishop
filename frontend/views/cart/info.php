	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
            ...
            <?php foreach ($carts as $cart):?>
				<tr data_id="<?=$cart->goods_id?>">
                    <?php $good = \backend\models\Goods::findOne(['id'=>$cart->goods_id])?>
					...
					<td class="col5">￥<span><?=$good->shop_price*$cart->amount?>.00</span></td>
					<td class="col6"><a href="" id="del">删除</a></td>
				</tr>
            <?php endforeach;?>
			</tbody>
			<tfoot>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="<?=\yii\helpers\Url::to(['cart/index'])?>" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
